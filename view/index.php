...
<body class="theme-default page-signin">
	...
	<div class="signin-container">
		...
		<div class="signin-info">
			...
			<div class="slogan">
				 Doação de Roupas, Calçados e Acessórios.
			</div> <!-- / .slogan -->
			<ul>
				<li><i class="fa fa-sitemap signin-icon"></i>Controle</li>
				<li><i class="fa fa-outdent signin-icon"></i>Relatórios</li>
				<li><i class="fa fa-heart signin-icon"></i> Doação</li>
			</ul> <!-- / Info list -->
		</div>
		<!-- / Left side -->
